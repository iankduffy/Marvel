    ...
    return (
      <div>
        <div className="intro">
          ...
          <p>Curabitur convallis ac massa non blandit. Fusce vitae eleifend nunc. Sed congue finibus odio, ut vestibulum orci luctus sit amet. Nunc at risus arcu. Proin feugiat lacinia ligula vitae porta. Curabitur vitae eros in lorem sagittis finibus. Nulla eleifend ex fringilla, gravida nisl in, gravida quam.</p>
        </div>
          {data}
      </div>
    );
